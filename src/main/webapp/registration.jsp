...
<%@ page import="com.epam.exhibitions.servlets.db.UserDAOImpl" %>
            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul id="menu" class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li><a href="#" class="nav-link px-2 ">Про музей</a></li>
                        <li><a href="#" class="nav-link px-2 ">Зали</a></li>
                        <li><a href="#" class="nav-link px-2 ">Виставки</a></li>
                        <% if("ADMINISTRATOR".equals(request.getSession().getAttribute("role"))){%>
                            <li><a href="#" class="nav-link px-2 ">Добавити виставку</a></li>
                        <% }%>
                    </ul>
                    ...
                    <div class="flex-shrink-0 dropdown">
                        ...
                        <ul id="myDropdown" class="dropdown-menu text-small dropdown-content">
                            ...
                            <li><a class="dropdown-item" href="#">Гаманець</a></li>
