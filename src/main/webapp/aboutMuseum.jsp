...
<head>
    ...
    <link rel="stylesheet" href="asserts/css/aboutmuseam-style.css">
...
<body>
<%  String language;
    session.setAttribute("responsePage","aboutMuseum.jsp");
            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul id="menu" class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li><a href="aboutMuseum.jsp" class="nav-link px-2 active "><fmt:message key="header.aboutMuseum"/> </a></li>
