<%@ page import="com.epam.exhibitions.servlets.db.entity.ExhibitionsBasket" %>
        ...
        <div class="col-12 col-md-10 col-lg-8 col-xl-8" style="background: #F2EAE4;padding: 10px">
            ...
            <div class="row">
                <div class="col-12" style="margin-top: 40px">
                    <h1 style="text-align: center;font-family: 'Comfortaa', cursive">Ваша корзина поки що порожня</h1>
                </div>
                <div class="col-12" style="margin-top: 40px">
            ...
            <% if (session.getAttribute("listUsersBasket")!=null){
                    ...
                    <div class="row ticket" style="margin: 20px 20px 20px">
                        ...
                        <div class="col-8">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <p class="data">Зал(и): <%=exhibitonHallsDAO.getHalls(exhibitionsBasket1.getExhibitions().getId_exhibition())%></p>
                                </div>
                                <div class="col-12">
                                    <p class="data">Ціна: <%=exhibitionsBasket1.getExhibitions().getPrice()%></p>
                                </div>
                                <div class="row">
                                    <div class="col-4">
                                        <div class="row">
                                    ...
                                    <div class="col-4">
                                        <p class="data">До оплати: <%=exhibitionsBasket1.getExhibitions().getPrice().multiply(new BigDecimal(exhibitionsBasket1.getNumber()))%></p>
                                    </div>
                                    <div class="col-4">
                                        <a href="toClean?id=<%=exhibitionsBasket1.getExhibitions().getId_exhibition()%>" style="text-decoration: none;"><p class="toClean">Прибрати <img src="asserts/img/clean.png" width="20px"></p></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row" style="margin-top: 30px">
                    <div class="col-5">
                        ...
                        %>
                        <h5 style="font-family: 'Comfortaa', cursive;text-align: center">Разом до оплати: <%= number%> $</h5>
                    </div>
                    <div class="col-3">
                        <a href="#"  onclick="postToUrl('Payment', {'username':'<%=session.getAttribute("username")%>'}, 'POST');" style="text-decoration: none;"><p class="toClean" style="background: white">Оплатити</p></a>
                    </div>
                    <div class="col-4"></div>
                </div>
            <div class="row">
