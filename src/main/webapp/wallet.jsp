        ...
        <div class="row">
            ...
            <div style="padding: 0;background: #F2EAE4" class="col-10 col-md-6 col-lg-4 col-xl-4" >
                ...
                <div class="paid">
                    <div class="row">
                        <div class="col-6">
                            <p style="font-family: 'Comfortaa', cursive">Введіть суму оплати:</p>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-12">
                            <p style="font-family: 'Comfortaa', cursive">Баланс: <%=request.getSession().getAttribute("wallet")%> $</p>
                        </div>
                        <div class="col-12">
                            <input id="button" type="submit" value="Поповнити" >
                        </div>
                    </div>
                </div>
